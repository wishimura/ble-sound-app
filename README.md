...
美術館・水族館・動物園などの施設で使う**音声ガイド Web アプリ**です。
来館者は QR を読み取るだけで施設専用画面が開き、展示の解説文と音声ガイドを楽しめます。

> データベースは **Neon (PostgreSQL)** を利用します（Supabase ではありません）。
>
> **クライアント向け使い方ガイドは [`USAGE.md`](./USAGE.md) を参照してください。**
> こちらの README は開発者向けセットアップ手順です。
