...
export const metadata = { title: '事業者ログイン' };
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-sm flex-col justify-center px-5">
      <div className="mb-6 text-center">
        ...
        <h1 className="mt-2 text-xl font-semibold text-ink">事業者ログイン</h1>
        <p className="mt-1 text-sm text-ink-muted">
          施設に発行された事業者アカウントでログインしてください
        </p>
      </div>
      <Card className="p-6">
      ...
      <div className="mt-4 rounded-xl border border-accent-soft bg-accent-soft/50 p-4 text-sm text-ink-soft">
        ...
        <dl className="mt-2 space-y-1 font-mono text-xs">
          <div className="flex gap-2">
            <dt className="w-28 text-ink-muted">事業者（美術館）</dt>
            <dd>art-admin@example.com</dd>
          </div>
          <div className="flex gap-2">
            <dt className="w-28 text-ink-muted">事業者（水族館）</dt>
